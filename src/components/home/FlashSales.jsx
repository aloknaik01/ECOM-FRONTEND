                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Limited time offers, act fast!</p>
                        </div>
                    </div>

                    <div className="flex items-center gap-4 bg-red-50 dark:bg-red-900/20 px-6 py-3 rounded-2xl border border-red-100 dark:border-red-900/30">
                        ...
                        <div className="flex gap-2">
                            {[
                                ...
                                <div key={i} className="flex items-baseline gap-1">
                                    ...
                                    <span className="text-xs font-bold text-red-400 dark:text-red-500 uppercase">{unit.label}</span>
                                </div>
                            ))}
                        </div>
                    </div>
