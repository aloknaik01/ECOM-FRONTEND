...
const FilterSection = ({ title, sectionKey, children, isExpanded, onToggle }) => (
        ...
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="w-full py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 text-sm font-medium rounded-lg transition-colors"
            >
              Apply
            </button>
          </div>
